...
ALU_Ops decode (const ALU_Type data) {
  if (data.instr.lsli.op == ALU_LSLI_OP) {
    ...
    // 315: insert code here to print subs instructioni
    if(opts.instrs) {
...
SP_Ops decode (const SP_Type data) {
  if (data.instr.mov.op == 2) {
    ...
    cout << "fuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuck" << endl;
    return SP_CMP;
  }
  else {
...
int decode (const LDM_Type data) {
  // 315: add code to print ldm 
	cout << "Implement LDM man!!!" << endl;
  return LDM;
}

int decode (const STM_Type data) {
  // 315: add code to print ldm 
		cout << dec << "Implement STM man!!!" << endl;

...
/** Questions
	...
	-For CMP, do I do two numRegWrites for carryoverflow
	 and for negativezero?

	-Do I need to update ASPR for every signle command??

	-For SP_ADD, which registers am i adding and where do I
	 store the result? Only gives me 2 registers????

	-STRBI , How do I get just a byte??? For these, is the
	 offset just the immediate / register vlaue?? Will it 
